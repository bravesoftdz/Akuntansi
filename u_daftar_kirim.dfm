object f_daftar_kirim: Tf_daftar_kirim
  Left = 326
  Top = 116
  Width = 928
  Height = 480
  ...
  object panel1: TsPanel
    ...
    object p1: TsPanel
      ...
      object sButton1: TsButton
        ...
        Width = 129
        Height = 41
        Caption = '&Tampilkan Seluruh Jurnal'#13#10'Kirim Barang'
        TabOrder = 0
      ...
      object sButton3: TsButton
        ...
        Width = 129
        Height = 41
        Caption = '&Print Preview'#13#10'Jurnal Kirim'
        TabOrder = 1
  ...
  object grid: TcxGrid
    ...
    object t_data1: TcxGridDBTableView
      ...
      DataController.DataSource = ds_daftar_kirim
    ...
    object t_data2: TcxGridDBTableView
      NavigatorButtons.ConfirmDelete = False
      DataController.DataSource = ds_rinci_kirim
    ...
    object t_data0: TcxGridDBTableView
      ...
      DataController.DataSource = ds_kirim
      DataController.Summary.DefaultGroupSummaryItems = <>
      DataController.Summary.FooterSummaryItems = <
        item
          Format = '###,###,##0;(###,###,##0);0'
      ...
      object t_data0tgl_kirim: TcxGridDBColumn
        Caption = 'Tanggal'
        DataBinding.FieldName = 'tgl_kirim'
        Width = 88
      end
  ...
  object ds_rinci_kirim: TDataSource
    DataSet = Q_rinci_kirim
    Left = 560
    Top = 96
  end
  object Q_rinci_kirim: TMyQuery
  ...
  object ds_kirim: TDataSource
    DataSet = Q_kirim
    Left = 408
    Top = 64
  end
  object Q_kirim: TMyQuery
    Connection = dm.db_conn
    SQL.Strings = (
  ...
  object ds_daftar_kirim: TDataSource
    DataSet = Q_daftar_kirim
    Left = 560
    Top = 56
  end
  object Q_daftar_kirim: TMyQuery
    Connection = dm.db_conn
    SQL.Strings = (
