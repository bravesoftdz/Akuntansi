...
PeekMessage(Mgs, 0, WM_CHAR, WM_CHAR, PM_REMOVE );
  FUNGSI.SQLExec(DM.Q_Show,'select kd_user,`password` as pass,n_user from tb_user where kd_perusahaan='+
  quotedstr(sb.Panels[0].Text)+' and kd_user="'+
  ed_kd_user.Text+'" and akun=''Y''',true);
...
PeriodAktif:= F_utama.sb.Panels[7].Text + F_utama.sb.Panels[6].Text;
